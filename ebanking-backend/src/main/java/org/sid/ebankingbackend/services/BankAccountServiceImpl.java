...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    @Override
    public BankAccountDTO getBankAccount(String accountId) throws BankNotFoundException {
    ...
    @Override
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws  BankNotFoundException {
        BankAccount bankAccount=bankAccountRepository.findById(accountId).orElse(null);
        if(bankAccount==null) throw new BankNotFoundException("Account not Found");
